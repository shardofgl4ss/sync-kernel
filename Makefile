...
SRC_KERNEL_INCLUDE_DIR  := $(SRC_KERNEL_DIR)/include
...
$(OBJS_KERNEL):		LOCAL_FLAGS := $(ASFLAGS_KRNL) -I$(SRC_KERNEL_DIR) -I$(SRC_KERNEL_DRIVERS_DIR) -I$(SRC_KERNEL_INCLUDE_DIR) -m64
